...
import Exporter from "../source/exporter.js";
    ...
    describe("Exporter", function () {
        ...
        describe("options.type", function () {
            it("should generate ES6 syntax if options.type is provided 'esm'", function () {
                ...
                return assert.equal(exporter._import("name", "./path.js"), "import name from \"./path.js\";");
            });
            ...
            it("should generate CommonJS syntax if options.type is provided 'cjs'", function () {
                ...
                return assert.equal(exporter._import("name", "./path.js"), "const name = require(\"./path.js\");");
            });
        })
